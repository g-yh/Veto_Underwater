...
module time_sync_manager (
    ...
    // output fifo interface (8-bit, rd on clk_uart)
...
module ptp_manager (
    ...
    // output fifo interface (8-bit, to uart)
    output wire [7:0] uart_data_out,
    input  wire       uart_read_enable,
    output wire       uart_read_empty,
    output wire       uart_read_valid,
    ...
    // debug
    assign flags = {ptp_t4_valid, ptp_t3_valid, ptp_t2_valid, ptp_t1_valid};
endmodule
